...
const NewPrivateFundForm: React.FC = () => {
  ...
  const handleManagerChange =
    (index: number, field: keyof ManagerTrusteeDirector) =>
        ...
        <>
          ...
          >
            ...
            <Typography variant="body1" paragraph>
              Please answer the following questions. This information will be
              used to disclose the firm's advisory relationship with its clients
              that are pooled investment vehicles.{' '}
              <strong>
                We would also request that you send us a copy of the private
                fund documents (e.g., PPM, LPA, subscription agreement) to us by
                e-mail.
              </strong>
            </Typography>
            <Typography variant="body1" paragraph>
              <strong>Please note:</strong> A separate form must be completed
              for EACH pooled investment vehicle with which your firm maintains
          ...
          <Box sx={{ border: '1px solid #ccc', borderRadius: 1, p: 3, mb: 3 }}>
            ...
            <Box sx={{ mb: 3 }}>
              <Typography variant="body1" gutterBottom>
                What is the full LEGAL name (including punctuation) of the
                private fund? <span style={{ color: 'red' }}>*</span>
              </Typography>
              <TextField
            ...
            <Box sx={{ mb: 3 }}>
              <Typography variant="body1" gutterBottom>
                Have you obtained an SEC Private Fund Identification Number for
                this fund? <span style={{ color: 'red' }}>*</span>
              </Typography>
              <RadioGroup
            ...
            <Box sx={{ mb: 3 }}>
              <Typography variant="body1" gutterBottom>
                Under the laws of what country is the private fund organized?{' '}
            ...
            <Box sx={{ mb: 3 }}>
              <Typography variant="body1" gutterBottom>
                Under the laws of what state is the private fund organized{' '}
                <span style={{ color: 'red' }}>*</span>
              </Typography>
              <FormControl size="small" sx={{ minWidth: '200px' }}>
                <Select
            ...
            <Box sx={{ mb: 3 }}>
              <Typography variant="body1" gutterBottom>
                Are you filing an umbrella registration?{' '}
                <span style={{ color: 'red' }}>*</span>
              </Typography>
              <RadioGroup
          ...
          <Box sx={{ border: '1px solid #ccc', borderRadius: 1, p: 3, mb: 3 }}>
            ...
            <Typography variant="body1" paragraph>
              Please list the full LEGAL name of the entity serving as General
              Partner (or equivalent) to this fund. Note that the next question
              asks about individual managers, trustees, and directors.
            </Typography>
            <Typography variant="body1" gutterBottom>
              <strong>Partner, Manager, Trustee, or Director</strong>
            </Typography>
            <Typography variant="body1" gutterBottom>
              General Partner (full LEGAL name of the entity, including
              punctuation) <span style={{ color: 'red' }}>*</span>
            </Typography>
            <TextField
          ...
          <Box sx={{ border: '1px solid #ccc', borderRadius: 1, p: 3, mb: 3 }}>
            ...
            <Typography variant="body1" paragraph>
              Please list the names and titles of any Managers, Trustees, or
              Directors of this fund
            </Typography>
            <Typography variant="body1" gutterBottom>
            ...
            {formData.managersDirectors.map((manager, index) => (
              <Box
                key={index}
                sx={{ display: 'flex', gap: 2, mb: 2, alignItems: 'end' }}
              >
                <Box>
                ...
                <Box>
                  ...
                  <FormControl size="small" sx={{ minWidth: '150px' }}>
                    <Select
                      value={manager.title}
                      onChange={(e) =>
                        handleManagerChange(index, 'title')(e as any)
                      }
                      displayEmpty
                      sx={{ backgroundColor: '#e3f2fd' }}
                    >
                      ...
                      <MenuItem value="Managing Partner">
                        Managing Partner
                      </MenuItem>
                    </Select>
                  </FormControl>
          ...
          <Box sx={{ mb: 3 }}>
            <Typography variant="body1" paragraph sx={{ fontStyle: 'italic' }}>
              <strong>Note:</strong> Please keep in mind that Form ADV{' '}
              <u>requires</u> that at least one of the following two questions{' '}
              <strong>[3(c)(1) or 3(c)(7)]</strong> must be answered "yes."
              These exemptions from the{' '}
              <strong>Investment Company Act of 1940</strong> are different than
              (and are in addition to) the Regulation D exemption from the{' '}
              <strong>Securities Act of 1933</strong>.
            </Typography>

            {/* Section 3(c)(1) Question */}
            <Box sx={{ mb: 3 }}>
              <Typography variant="body1" gutterBottom>
                1) Does this Private Fund qualify for exclusion form the
            ...
            <Box sx={{ mb: 3 }}>
              <Typography variant="body1" gutterBottom>
                2) Does this Private Fund qualify for exclusion form the
                definition of investment company under section 3(c)(7) of the
                Investment Company Act of 1940?{' '}
                <span style={{ color: 'red' }}>*</span>
              </Typography>
              <RadioGroup
            ...
            <Box sx={{ mb: 3 }}>
              <Typography variant="body1" gutterBottom>
                Is this Private Fund registered with a foreign regulatory
            ...
            <Box sx={{ mb: 3 }}>
              <Typography variant="body1" gutterBottom>
                Is this Private Fund a "Master Fund" in a master-feeder
                arrangement? <span style={{ color: 'red' }}>*</span>
              </Typography>
              <RadioGroup
            ...
            <Box sx={{ mb: 3 }}>
              <Typography variant="body1" gutterBottom>
                Is this Private Fund a "Feeder Fund" in a master-feeder
                arrangement? <span style={{ color: 'red' }}>*</span>
              </Typography>
              <RadioGroup
            ...
            <Box sx={{ mb: 3 }}>
              <Typography variant="body1" gutterBottom>
                Is this private fund a "fund of funds"?{' '}
                <span style={{ color: 'red' }}>*</span>
              </Typography>
              <RadioGroup
            ...
            <Box sx={{ mb: 3 }}>
              <Typography variant="body1" gutterBottom>
                During your last fiscal year, did the private fund invest in
            ...
            <Box sx={{ mb: 3 }}>
              <Typography variant="body1" gutterBottom>
                What type of fund is this private fund?{' '}
                <span style={{ color: 'red' }}>*</span>
              </Typography>
              <RadioGroup
              ...
              >
                ...
                />
                <FormControlLabel
                  value="Securitized asset fund"
                  control={<Radio />}
                  label="Securitized asset fund"
                />
                <FormControlLabel
      ...
      {currentPage === 2 && (
        <>
          ...
          <Box sx={{ border: '1px solid #ccc', borderRadius: 1, p: 3, mb: 3 }}>
            ...
            <Box sx={{ mb: 3 }}>
              <Typography variant="body1" gutterBottom>
                What is the current gross asset value of the private fund?{' '}
                <span style={{ color: 'red' }}>*</span>
              </Typography>
              <TextField
            ...
            <Box sx={{ mb: 3 }}>
              <Typography variant="body1" gutterBottom>
                What is the minimum investment commitment required of an
                investor in the private fund?{' '}
                <span style={{ color: 'red' }}>*</span>
              </Typography>
              <TextField
              ...
              >
                Please report the amount routinely required of investors who are
                not your related persons
              </Typography>
            </Box>
            ...
            <Box sx={{ mb: 3 }}>
              <Typography variant="body1" gutterBottom>
                Approximately how many beneficial owners does this private fund
                have? <span style={{ color: 'red' }}>*</span>
              </Typography>
              <TextField
            ...
            <Box sx={{ mb: 3 }}>
              <Typography variant="body1" gutterBottom>
                What is the approximate percentage of the private fund
            ...
            <Box sx={{ mb: 3 }}>
              <Typography variant="body1" gutterBottom>
                What is the approximate percentage of the private fund
                beneficially owner (in the aggregate) by funds of funds?{' '}
                <span style={{ color: 'red' }}>*</span>
              </Typography>
              <TextField
            ...
            <Box sx={{ mb: 3 }}>
              <Typography variant="body1" gutterBottom>
                Does this private fund have any non-United States persons as
          ...
          <Box sx={{ border: '1px solid #ccc', borderRadius: 1, p: 3, mb: 3 }}>
            ...
            <Box sx={{ mb: 3 }}>
              <Typography variant="body1" gutterBottom>
                Are you a sub-adviser to this private fund?{' '}
                <span style={{ color: 'red' }}>*</span>
              </Typography>
              <RadioGroup
            ...
            <Box sx={{ mb: 3 }}>
              <Typography variant="body1" gutterBottom>
                Do any other advisers manage this private fund?{' '}
                <span style={{ color: 'red' }}>*</span>
              </Typography>
              <RadioGroup
            ...
            <Box sx={{ mb: 3 }}>
              <Typography variant="body1" gutterBottom>
                Will the clients of your advisory firm have the opportunity to
                invest in the fund? <span style={{ color: 'red' }}>*</span>
              </Typography>
              <RadioGroup
          ...
          <Box sx={{ border: '1px solid #ccc', borderRadius: 1, p: 3, mb: 3 }}>
            ...
            <Box sx={{ mb: 3 }}>
              <Typography variant="body1" gutterBottom>
                Has the private fund ever relied on an exemption from
                registration of its securities under Regulation D of the
                Securities Act of 1933? <span style={{ color: 'red' }}>*</span>
              </Typography>
              <RadioGroup
      ...
      {currentPage === 3 && (
        <>
          ...
          <Box sx={{ border: '1px solid #ccc', borderRadius: 1, p: 3, mb: 3 }}>
            ...
            <Box sx={{ mb: 3 }}>
              <Typography variant="body1" gutterBottom>
                Are the private fund's financial statements subject to an annual
                audit? <span style={{ color: 'red' }}>*</span>
              </Typography>
              <RadioGroup
      ...
      {currentPage === 4 && (
        <>
          ...
          <Box sx={{ border: '1px solid #ccc', borderRadius: 1, p: 3, mb: 3 }}>
            ...
            <Box sx={{ mb: 3 }}>
              <Typography variant="body1" gutterBottom>
                Does the private fund use one or more prime brokers?{' '}
                <span style={{ color: 'red' }}>*</span>
              </Typography>
              <RadioGroup
      ...
      {currentPage === 5 && (
        <>
          ...
          <Box sx={{ border: '1px solid #ccc', borderRadius: 1, p: 3, mb: 3 }}>
            ...
            <Box sx={{ mb: 3 }}>
              <Typography variant="body1" gutterBottom>
                Does this private fund use any custodian (including the prime
                brokers listed on the previous page) to hold some or all of its
      ...
      {currentPage === 6 && (
        <>
          ...
          <Box sx={{ border: '1px solid #ccc', borderRadius: 1, p: 3, mb: 3 }}>
            ...
            <Box sx={{ mb: 3 }}>
              <Typography variant="body1" gutterBottom>
                Does this private fund use an administrator other than your
            ...
            <Box sx={{ mb: 3 }}>
              <Typography variant="body1" gutterBottom>
                During the last fiscal year, what percentage of the private
                fund's assets (by value) was valued by a person, such as an
                administrator, that is not your related person?{' '}
                <span style={{ color: 'red' }}>*</span>
              </Typography>
              <TextField
      ...
      {currentPage === 7 && (
        <>
          ...
          <Box sx={{ border: '1px solid #ccc', borderRadius: 1, p: 3, mb: 3 }}>
            ...
            <Box sx={{ mb: 3 }}>
              <Typography variant="body1" gutterBottom>
                Does this private fund use the services of someone other than
                you or your employees for marketing purposes?{' '}
                <span style={{ color: 'red' }}>*</span>
              </Typography>
              <RadioGroup
