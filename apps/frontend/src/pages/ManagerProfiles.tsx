...
import { Users, Buildings, Star, MagnifyingGlass, GlobeHemisphereWest, Funnel, ArrowsClockwise } from '@phosphor-icons/react';
  ...
  const managers = [
    {
      ...
      description: 'Sequoia Capital is an American venture capital firm specializing in investments in early-stage and growth-stage companies across technology sectors.',
    },
    {
      id: 2,
      name: 'Blackstone',
      ...
      description: 'Blackstone is one of the world\'s leading investment firms with a diverse portfolio across private equity, real estate, and credit investments.',
    },
    {
      id: 3,
      name: 'KKR',
      ...
      description: 'KKR is a global investment firm that manages multiple alternative asset classes including private equity, infrastructure, and credit.',
    },
    {
      id: 4,
    ...
    },
    {
      ...
      investments: 1200,
      exits: 250,
      focus: ['Business Services', 'Consumer', 'Financial Services', 'Healthcare'],
      description: 'CVC Capital Partners is a leading private equity and investment advisory firm with a global network of offices across Europe, the Americas, and Asia.',
    },
    {
      id: 6,
      ...
      description: 'Tiger Global Management is an investment firm focused on public and private companies in the global internet, software, consumer, and financial technology industries.',
    },
  ];
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="bg-white rounded-lg shadow p-6">
          <div className="flex items-center justify-between mb-4">
            <h3 className="text-lg font-medium text-gray-900">Total Managers</h3>
            <Users className="w-6 h-6 text-blue-600" />
          </div>
          <p className="text-3xl font-bold text-gray-900">{managers.length}</p>
          <p className="text-sm text-gray-500 mt-1">Across multiple strategies</p>
        </div>
        ...
        <div className="bg-white rounded-lg shadow p-6">
          ...
          <p className="text-sm text-gray-500 mt-1">Combined assets under management</p>
        </div>
        ...
        <div className="bg-white rounded-lg shadow p-6">
          ...
          <p className="text-sm text-gray-500 mt-1">Countries with active investments</p>
        </div>
      </div>

      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="bg-white rounded-lg shadow p-6 md:col-span-1">
          <h3 className="text-lg font-medium text-gray-900 mb-4">AUM Distribution</h3>
          <div className="h-64">
            <DonutChart
        ...
        <div className="bg-white rounded-lg shadow p-6 md:col-span-2">
          <h3 className="text-lg font-medium text-gray-900 mb-4">Manager Type Distribution</h3>
          <div className="space-y-4">
            <div className="bg-gray-50 p-4 rounded-lg">
              ...
              <div className="flex justify-between items-center mt-2">
                ...
                <span className="ml-4 text-sm font-medium text-gray-700">50%</span>
              </div>
            </div>
            <div className="bg-gray-50 p-4 rounded-lg">
              ...
              <div className="flex justify-between items-center mt-2">
                ...
                <span className="ml-4 text-sm font-medium text-gray-700">33%</span>
              </div>
            </div>
            <div className="bg-gray-50 p-4 rounded-lg">
              ...
              <div className="flex justify-between items-center mt-2">
                <div className="w-full bg-gray-200 rounded-full h-2.5">
                  <div className="bg-pink-600 h-2.5 rounded-full" style={{ width: '17%' }}></div>
                </div>
                <span className="ml-4 text-sm font-medium text-gray-700">17%</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between mb-6 gap-4">
          ...
          <div className="flex items-center gap-2">
            ...
            <Button
              variant="ghost"
              size="small"
              onClick={() => setSelectedFilters({ type: [], region: [], aum: [] })}
            >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {filteredManagers.length > 0 ? (
            filteredManagers.map((manager) => (
              <div key={manager.id} className="border rounded-lg overflow-hidden hover:shadow-md transition-shadow">
                ...
                <div className="p-4">
                  <p className="text-sm text-gray-600 mb-4">{manager.description}</p>
                  ...
                  <div className="mt-4">
                    <p className="text-gray-500 text-sm mb-1">Investment Focus</p>
            ...
            <div className="col-span-full text-center py-12 bg-gray-50 rounded-md">
              ...
              <p className="text-gray-500 mb-2">No managers found matching your criteria.</p>
